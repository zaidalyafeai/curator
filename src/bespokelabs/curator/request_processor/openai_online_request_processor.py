    ...
    if api_endpoint.endswith("completions"):
        ...
        if api_endpoint.startswith("chat/"):
            ...
            if isinstance(prompt, str):
                ...
                raise TypeError('Expecting string or list of strings for "prompt" field')
        ...
        if isinstance(input, str):
            ...
            raise TypeError('Expecting string or list of strings for "inputs" field')
    else:
        raise NotImplementedError(f'API endpoint "{api_endpoint}" not implemented')
