...
class AnthropicBatchRequestProcessor(BaseRequestProcessor):
    def __init__(
        self,
        batch_size: int,
        model: str,
        ...
        url: str = "https://api.anthropic.com/v1/messages/batches",
        ...
        if batch_size > MAX_REQUESTS_PER_BATCH:
            raise ValueError(
                ...
                f"{MAX_REQUESTS_PER_BATCH:,} requests per batch that {self.__class__.__name__} supports. "
